...
from data import SeqRecDataset, SeqRecDatasetCSV
import math
...
def parse_global_args(parser):
    ...
    parser.add_argument("--base_model", type=str, default="/media/zhengbowen/ckpt/tiger/",help="basic model path")

    parser.add_argument("--output_dir", type=str,
                        default="/media/zhengbowen/ckpt/tiger/",
                        help="The output directory")
    parser.add_argument("--special_token_for_answer", default=None, help="activate for Qwen backbone")
...
def parse_dataset_args(parser):
    parser.add_argument("--data_path", type=str, default="/media/zhengbowen/data/Amazon2018/Processed/",
                        help="data directory")

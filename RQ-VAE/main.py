...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str,
                        default="/media/zhengbowen/data/Amazon2018/Processed/Games/Games.emb-llama-td.npy",
                        help="Input data path.")
    parser.add_argument("--dataset", default="Toys_and_Games", type=str)
    ...
    parser.add_argument("--ckpt_dir", type=str, default="./checkpoints/", help="output directory for model")
...
if __name__ == '__main__':
    ...
    args = parse_args()
    print(args)
    args.ckpt_dir = args.ckpt_dir + f"{args.dataset}"
